...
![image-20230514204456321](高级语言程序设计实验报告.assets\image-20230514204456321.png)
...
- 注意到VSCode新建若干个未与文件关联的标签页时，会选取当前可用的最小标签页。如下图所示新建标签页会命名为`Untitled-2`。在这个项目中也复现了这样的设计。
  ...
  ![image-20230514201910114](高级语言程序设计实验报告.assets\image-20230514201910114.png)
...
![image-20230514210950317](高级语言程序设计实验报告.assets\image-20230514210950317.png)
...
![image-20230514230623432](高级语言程序设计实验报告.assets\image-20230514230623432.png)
...
![image-20230514220624197](高级语言程序设计实验报告.assets\image-20230514220624197.png)
...
![image-20230515153815269](高级语言程序设计实验报告.assets/image-20230515153815269.png)
...
![image-20230514231847964](高级语言程序设计实验报告.assets\image-20230514231847964.png)
...
![image-20230514234245615](高级语言程序设计实验报告.assets\image-20230514234245615.png)

同样的道理，我们甚至可以让它构建自己:

![image-20230514234354199](高级语言程序设计实验报告.assets\image-20230514234354199.png)

![image-20230514234428154](高级语言程序设计实验报告.assets\image-20230514234428154.png)
